  ...
  return (
    <Card className="max-w-md">
      ...
      <CardContent className="space-y-4">
        <div className="aspect-video rounded-lg bg-neutral-100 flex items-center justify-center overflow-hidden">
          {slot.image_url ? (
            <img
              src={slot.image_url}
            ...
            <span className="text-neutral-300 text-sm">No image generated</span>
          )}
        </div>
        ...
        {slot.critic_summary && (
          <div>
            ...
            <p className="text-sm mt-1 text-neutral-600 italic">
